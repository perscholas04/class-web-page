...
export interface TextAreaFieldMultilineProps extends TextFieldOptions, TextAreaProps {
}
export declare type TextFieldProps<Multiline extends boolean = false> = (Multiline extends true ? TextAreaFieldMultilineProps : TextInputFieldProps) & {
    /**
     * @deprecated
