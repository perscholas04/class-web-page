 ...
 */
export declare const usePaginationItems: (currentPage: number, totalPages: number, hasMorePages: boolean, siblingCount: number, onNext: () => void, onPrevious: () => void, onChange: (newPageIdx: number, prevPageIdx: any) => void) => JSX.Element[];
