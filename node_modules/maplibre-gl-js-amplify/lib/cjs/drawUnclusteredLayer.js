 ...
 */
function addUnclusteredMarkerImages(map, { selectedColor = constants_1.ACTIVE_MARKER_COLOR, selectedBorderColor = constants_1.COLOR_WHITE, selectedBorderWidth = 4, defaultBorderColor = constants_1.COLOR_WHITE, defaultBorderWidth = 4, defaultColor: fillColor = constants_1.MARKER_COLOR, }) {
    const inactiveMarker = (0, createMarker_1.createMarker)({
        fillColor: fillColor,
        strokeColor: defaultBorderColor,
        lineWidth: defaultBorderWidth,
    });
    const activeMarker = (0, createMarker_1.createMarker)({
...
//# sourceMappingURL=drawUnclusteredLayer.js.map