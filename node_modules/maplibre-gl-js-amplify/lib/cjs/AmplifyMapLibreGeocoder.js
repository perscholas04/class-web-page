...
function createAmplifyGeocoder(options) {
    return new maplibre_gl_geocoder_1.default(exports.AmplifyGeocoderAPI, Object.assign({ maplibregl: maplibre_gl_1.default, showResultMarkers: { element: (0, createDefaultIcon_1.createDefaultIcon)() }, marker: { element: (0, createDefaultIcon_1.createDefaultIcon)() } }, options));
}
exports.createAmplifyGeocoder = createAmplifyGeocoder;
//# sourceMappingURL=AmplifyMapLibreGeocoder.js.map